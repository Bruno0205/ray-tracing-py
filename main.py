...
def main():
    ...
    # Benchmark: compara renderização com e sem Octree
    print("Renderizando COM Octree...")
    ray_casting.__generate_image__(entidades5, luzes_da_cena, 1, camera2, use_octree=True, window_name="Com Octree")

    print("Renderizando SEM Octree...")
    ray_casting.__generate_image__(entidades5, luzes_da_cena, 1, camera2, use_octree=False, window_name="Sem Octree")
